...
def _verify_input_params_general(params: FullConfig) -> None:
    ...
    if params['general']['beta'] is not None and not params['general']['gw_embedding'] and (params['general']['n_iw'] is None
                                                  or params['general']['n_tau'] is None):
        raise ValueError('Imaginary-frequency grid chosen, specify "n_iw" and "n_tau".')

    if params['general']['beta'] is None and not params['general']['gw_embedding'] and (params['general']['eta'] is None or params['general']['n_w'] is None
    ...
    h_int_type_options = ('density_density', 'kanamori', 'full_slater', 'crpa',
                          'crpa_density_density', 'dyn_density_density', 'dyn_full', 'ntot', 'simple_intra')
